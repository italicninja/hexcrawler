...
type WeatherDifficultyTable = Record<string, number>;

export class EncounterManager {
  encounterTables: EncounterTable;
  difficultyModifiers: { weather: WeatherDifficultyTable };
   ...
   */
  getEncounter(terrainType: TerrainType, random: () => number): EncounterEntry {
   ...
   */
  calculateDifficulty(terrain: TerrainType, weather: WeatherCondition | null): number {
   ...
   */
  getMovementModifier(difficulty: number): number {
