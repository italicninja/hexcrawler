...
const clericCantrips = [
  new Spell({
    ...
    description:
      'Flame-like radiance descends on a creature. Target must succeed on a Dexterity saving throw or take 1d8 radiant damage.',
...
const clericLevel1 = [
  ...
  new Spell({
    ...
    attackRoll: true,
    description:
      'A flash of light streaks toward a creature. Make a ranged spell attack. On a hit, the target takes 4d6 radiant damage.',
    effect: (caster, target, diceRoller) => {
...
const clericLevel2 = [
  new Spell({
    ...
    attackRoll: true,
    description:
      'You create a floating spectral weapon. As a bonus action, you can move it and make a melee spell attack dealing 1d8 + spellcasting modifier force damage.',
    effect: (caster, target, diceRoller) => {
  ...
  new Spell({
    ...
    savingThrow: 'wisdom',
    description:
      'Choose a humanoid that you can see. The target must succeed on a Wisdom saving throw or be paralyzed.',
    effect: (caster, target, diceRoller) => {
...
const clericLevel3 = [
  new Spell({
    ...
    savingThrow: 'wisdom',
    description:
      'You call spirits to protect you. When a creature enters the area or starts its turn there, it must make a Wisdom saving throw or take 3d8 radiant damage (half on success).',
    effect: (caster, target, diceRoller) => {
...
const wizardCantrips = [
  new Spell({
    ...
    attackRoll: true,
    description:
      'You hurl a mote of fire at a creature. Make a ranged spell attack. On a hit, the target takes 1d10 fire damage.',
    effect: (caster, target, diceRoller) => {
  ...
  new Spell({
    ...
    attackRoll: true,
    description:
      'A frigid beam of blue-white light streaks toward a creature. Make a ranged spell attack. On a hit, it takes 1d8 cold damage and its speed is reduced by 10 feet.',
    effect: (caster, target, diceRoller) => {
  ...
  new Spell({
    ...
    attackRoll: true,
    description:
      'Lightning springs from your hand. Make a melee spell attack. On a hit, the target takes 1d8 lightning damage and cannot take reactions.',
    effect: (caster, target, diceRoller) => {
...
const wizardLevel1 = [
  new Spell({
    ...
    targetType: 'enemy',
    description:
      'You create three glowing darts of magical force. Each dart hits a creature and deals 1d4+1 force damage.',
    effect: (caster, target, diceRoller) => {
  ...
  new Spell({
    ...
    savingThrow: 'dexterity',
    description:
      'A thin sheet of flames shoots forth. Each creature in a 15-foot cone must make a Dexterity saving throw or take 3d6 fire damage (half on success).',
    effect: (caster, target, diceRoller) => {
  ...
  new Spell({
    ...
    targetType: 'area',
    description:
      'Roll 5d8; creatures within a 20-foot radius fall unconscious until their combined HP equals the roll total.',
    effect: (caster, target, diceRoller) => {
...
const wizardLevel2 = [
  new Spell({
    ...
    attackRoll: true,
    description:
      'You create three rays of fire. Make a ranged spell attack for each ray. On a hit, the target takes 2d6 fire damage.',
    effect: (caster, target, diceRoller) => {
  ...
  new Spell({
    ...
    savingThrow: 'dexterity',
    description:
      'You conjure thick, sticky webbing. Creatures in the area must make a Dexterity saving throw or be restrained.',
    effect: (caster, target, diceRoller) => {
...
const wizardLevel3 = [
  new Spell({
    ...
    savingThrow: 'dexterity',
    description:
      'A bright streak flashes to a point you choose and explodes in a 20-foot radius. Creatures must make a Dexterity saving throw or take 8d6 fire damage (half on success).',
    effect: (caster, target, diceRoller) => {
  ...
  new Spell({
    ...
    savingThrow: 'dexterity',
    description:
      'A stroke of lightning forms a 100-foot-long, 5-foot-wide line. Creatures must make a Dexterity saving throw or take 8d6 lightning damage (half on success).',
    effect: (caster, target, diceRoller) => {
...
const druidCantrips = [
  new Spell({
    ...
    attackRoll: true,
    description:
      'A flickering flame appears in your hand. You can hurl it at a creature, making a ranged spell attack dealing 1d8 fire damage.',
    effect: (caster, target, diceRoller) => {
...
const druidLevel1 = [
  new Spell({
    ...
    description:
      'Grasping weeds and vines sprout from the ground in a 20-foot square. Creatures must make a Strength saving throw or be restrained.',
    effect: (caster, target, diceRoller) => {
  ...
  new Spell({
    ...
    description:
      'A wave of thunderous force sweeps out. Creatures must make a Constitution saving throw or take 2d8 thunder damage and be pushed 10 feet (half damage on success).',
    effect: (caster, target, diceRoller) => {
...
const druidLevel2 = [
  new Spell({
    ...
    savingThrow: 'constitution',
    description:
      'A silvery beam of pale light shines down in a 5-foot radius. Creatures must make a Constitution saving throw or take 2d10 radiant damage (half on success).',
    effect: (caster, target, diceRoller) => {
  ...
  new Spell({
    ...
    savingThrow: 'constitution',
    description:
      'Choose a manufactured metal object. Any creature in physical contact with it takes 2d8 fire damage and must make a Constitution saving throw or drop the object.',
    effect: (caster, target, diceRoller) => {
...
const druidLevel3 = [
  new Spell({
    ...
    savingThrow: 'dexterity',
    description:
      'A storm cloud appears. You can call down a bolt of lightning dealing 3d10 lightning damage (Dexterity save for half).',
    effect: (caster, target, diceRoller) => {
...
const bardCantrips = [
  new Spell({
    ...
    savingThrow: 'wisdom',
    description:
      'You unleash a string of insults. The target must make a Wisdom saving throw or take 1d4 psychic damage and have disadvantage on its next attack roll.',
    effect: (caster, target, diceRoller) => {
...
const bardLevel1 = [
  new Spell({
    ...
    savingThrow: 'dexterity',
    description:
      'Objects and creatures in a 20-foot cube are outlined in light. Attack rolls against affected creatures have advantage.',
    effect: (caster, target, diceRoller) => {
  ...
  new Spell({
    ...
    savingThrow: 'wisdom',
    description:
      'You attempt to charm a humanoid. The target must make a Wisdom saving throw or be charmed by you.',
    effect: (caster, target, diceRoller) => {
...
const bardLevel2 = [
  new Spell({
    ...
    savingThrow: 'constitution',
    description:
      'A sudden loud ringing noise erupts in a 10-foot radius sphere. Creatures must make a Constitution saving throw or take 3d8 thunder damage (half on success).',
    effect: (caster, target, diceRoller) => {
...
const bardLevel3 = [
  new Spell({
    ...
    savingThrow: 'wisdom',
    description:
      'A twisting pattern of colors appears. Creatures must make a Wisdom saving throw or become charmed and incapacitated.',
    effect: (caster, target, diceRoller) => {
...
const sorcererLevel1 = [
  ...
  new Spell({
    ...
    attackRoll: true,
    description:
      'You hurl a 4-inch sphere of energy. Make a ranged spell attack. On a hit, the target takes 3d8 damage of a type you choose.',
    effect: (caster, target, diceRoller) => {
...
const warlockCantrips = [
  new Spell({
    ...
    attackRoll: true,
    description:
      'A beam of crackling energy streaks toward a creature. Make a ranged spell attack. On a hit, the target takes 1d10 force damage.',
    effect: (caster, target, diceRoller) => {
...
const warlockLevel3 = [
  new Spell({
    ...
    savingThrow: 'dexterity',
    description:
      'You open a gateway to the dark between the stars. Creatures in a 20-foot sphere take 2d6 cold damage at the start of their turn.',
    effect: (caster, target, diceRoller) => {
...
const paladinLevel3 = [
  ...
  new Spell({
    ...
    targetType: 'ally',
    description:
      'Healing energy radiates from you. On your turn, you can use a bonus action to restore 2d6 hit points to one creature in the aura.',
    effect: (caster, target, diceRoller) => {
...
const rangerLevel2 = [
  ...
  new Spell({
    ...
    targetType: 'area',
    description:
      'The ground in a 20-foot radius twists and sprouts hard spikes. The area becomes difficult terrain. When a creature moves into or within the area, it takes 2d4 piercing damage for every 5 feet it travels.',
    effect: (caster, target, diceRoller) => {
...
const rangerLevel3 = [
  ...
  new Spell({
    ...
    targetType: 'enemy',
    description:
      'The next time you make a ranged weapon attack, the ammunition transforms into a lightning bolt. On a hit, the target takes an extra 4d8 lightning damage.',
    effect: (caster, target, diceRoller) => {
