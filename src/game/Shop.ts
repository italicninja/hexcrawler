    ...
    const tables = {
      ...
      uncommon: [
        ...
        },
        {
          ...
          weight: 5,
          value: 110,
          description: 'A sturdy warhammer.',
        },
        {
          name: 'Longbow +1',
          type: 'weapon',
      ...
      rare: [
        ...
        },
        {
          ...
          weight: 7,
          value: 1200,
          description: 'A massive magical greataxe.',
          twoHanded: true,
        },
        {
          ...
          weight: 5,
          value: 1100,
          description: 'A hammer imbued with frost.',
        },
        {
          ...
          weight: 2,
          value: 1500,
          description: 'A bow that never misses.',
          twoHanded: true,
        },
      ],
      'very rare': [
        {
          ...
          weight: 3,
          value: 10000,
          description: 'A legendary blade that severs heads.',
        },
      ],
      legendary: [
        {
          ...
          weight: 3,
          value: 50000,
          description: 'The ultimate weapon against evil.',
        },
      ],
    };
    ...
    const tables = {
      common: [
        ...
        },
        {
          ...
          weight: 8,
          value: 15,
          description: 'Simple padded armor.',
        },
        {
          name: 'Leather Boots',
          type: 'armor',
      ...
      uncommon: [
        ...
        },
        {
          ...
          weight: 2,
          value: 150,
          description: 'Gloves that enhance strength.',
        },
        {
          name: 'Steel Shield +1',
          type: 'armor',
      ...
      rare: [
        {
          ...
          weight: 20,
          value: 1500,
          description: 'Lightweight mithril armor.',
        },
        {
          name: 'Plate Armor +1',
          type: 'armor',
          ...
          weight: 50,
          value: 2000,
          description: 'Enhanced plate armor.',
        },
        {
          name: 'Winged Boots',
          type: 'armor',
          slot: 'feet',
          effects: { dex: 2, speed: 15 },
          weight: 1,
          value: 1800,
        ...
        },
        {
          ...
          weight: 3,
          value: 1600,
          description: 'A helm that enhances mind.',
        },
        {
          name: 'Tower Shield +2',
          type: 'armor',
      ...
      'very rare': [
        {
          ...
          weight: 50,
          value: 12000,
          description: 'Masterwork plate armor.',
        },
      ],
      legendary: [
        {
          ...
          weight: 50,
          value: 75000,
          description: 'Nearly indestructible armor.',
        },
      ],
    };
    return tables[rarity] || [];
    ...
    const tables = {
      common: [
        ...
        },
        {
          ...
          weight: 5,
          value: 10,
          description: 'Dried food for 5 days.',
        },
        {
          name: 'Waterskin (5 days)',
          type: 'misc',
          effects: {},
          weight: 5,
          value: 5,
          description: 'Water for 5 days.',
        },
        {
          name: 'Rope (50ft)',
          type: 'misc',
        ...
        },
        {
          ...
          weight: 5,
          value: 5,
          description: 'Pack of 10 torches.',
        },
        {
          name: 'Bedroll',
          type: 'misc',
          ...
          weight: 7,
          value: 3,
          description: 'A bedroll for camping.',
        },
        {
          name: 'Backpack',
          type: 'misc',
      ...
      uncommon: [
        ...
        },
        {
          ...
          value: 75,
          consumable: true,
          description: 'Grants climbing ability for 1 hour.',
        },
        {
          ...
          value: 80,
          consumable: true,
          description: 'Makes surfaces slippery.',
        },
        {
          name: 'Antitoxin',
          type: 'consumable',
      ...
      rare: [
        ...
        },
        {
          ...
          value: 200,
          consumable: true,
          description: 'Grants +2 STR for 1 hour.',
        },
        {
          ...
          value: 250,
          consumable: true,
          description: 'Grants damage resistance.',
        },
      ],
      'very rare': [
        {
    ...
    const tables = {
      common: [
        {
          ...
          weight: 0.1,
          value: 25,
          description: 'A scroll with a basic cantrip.',
        },
        {
          name: 'Potion of Minor Healing',
          type: 'consumable',
      ...
      'very rare': [
        ...
        },
        {
          ...
          weight: 0.5,
          value: 12000,
          description: 'Allows planar travel.',
        },
      ],
      legendary: [
        {
          ...
          weight: 0.1,
          value: 100000,
          description: 'Grants three wishes.',
          charges: 3,
          maxCharges: 3,
        },
        {
          ...
          weight: 4,
          value: 150000,
          description: 'Ultimate magical staff.',
          charges: 50,
          maxCharges: 50,
        },
      ],
