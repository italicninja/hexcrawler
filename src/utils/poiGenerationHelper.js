 ...
 * @param {Object} terrainType - Terrain type object with name and properties
 * @param {number} col - Column coordinate
 * @param {number} row - Row coordinate
 * @param {number} chance - Probability of POI generation (0.0 to 1.0), default 0.2 (20%)
 * @returns {Object|null} Generated POI object or null if no POI generated
 */
 ...
 * @param {number} col - Column coordinate
 * @param {number} row - Row coordinate
 * @param {number} mapWidth - Total map width (for terrain generation)
 * @param {number} mapHeight - Total map height (for terrain generation)
 * @param {number} terrainVariety - Terrain variety parameter (0.0 to 1.0)
