...
const POI_FLAVOR = {
  ...
  cave: {
    low: [
      "A shallow cave opening beckons",
      "Natural rock formations create a small cavern"
    ],
    medium: [
  ...
  shrine: {
    low: [
      "A humble shrine stands peacefully",
      "Simple offerings mark this sacred place"
    ],
    medium: [
  ...
  encounter: {
    ...
    medium: [
      "Dangerous enemies block your path ahead",
      "A hostile force prepares to engage you"
    ],
    high: [
...
const COMBAT_INTROS = {
  ...
  generic: [
    "Combat begins!",
    "Enemies engage - ready your weapons!",
    "Battle is joined!"
  ]
};
