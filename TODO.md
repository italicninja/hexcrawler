...
**Priority:** High | **Time:** 8-12 hours | **Status:** IN PROGRESS (8 files remaining, down from 100 — generators + HexGrid/Interior canvas done; CombatCanvas, 4 scenes, Combat (+combatReducer), DevTools left)
